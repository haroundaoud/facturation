            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="submenuFacture">
                    <ul class="nav flex-column ms-4">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="listedevis.php">
                                <i class="bi bi-list-ul text-dark text-sm opacity-10 me-2"></i>
                                Liste des devis
                            </a>
                        </li>
...
<main class="main-content position-relative border-radius-lg ">
    ...
    $stmt_articles = $db->prepare("SELECT de.*, p.*,c.*,ded.* FROM produits p , devis de,clients c,devis_details ded  where c.id=de.client_id and ded.devis_id=de.id and ded.produit_id=p.code_barre");
    ...
    <div class="container-fluid py-4">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="javascript:void(0);" class="btn btn-danger btn-sm"
                                           onclick="confirmDeleteFacture(<?php echo $article['devis_id']; ?>)">
                                            <i class="bi bi-trash-fill"></i> Supprimer
                                        </a>

                                        <a href="javascript:void(0);" class="btn btn-warning btn-sm"
                                           onclick="makeFacture(<?php echo $article['devis_id']; ?>)">
                                            <i class="bi bi-palette"></i> fact
                                        </a>
                                        <a href="javascript:void(0);" class="btn btn-print btn-sm"
                                           onclick="makepdf(<?php echo $article['devis_id']; ?>)">
        ...
        <script>
            ...
            // make devis facture
            function makeFacture(factureId)
        </script>
