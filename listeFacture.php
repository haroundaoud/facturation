...
<main class="main-content position-relative border-radius-lg ">
    ...
    $stmt_articles = $db->prepare("SELECT fa.*, p.*,c.*,fat.* FROM produits p , factures fa,clients c,facture_details fat  where c.id=fa.client_id and fat.facture_id=fa.id and fat.produit_id=p.code_barre");
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="javascript:void(0);" class="btn btn-warning btn-sm"
                       onclick="makeFacture(<?php echo $article['facture_id']; ?>)">
                        <i class="bi bi-palette"></i> fact
                    </a>
                    <a href="javascript:void(0);" class="btn btn-print btn-sm"
                       onclick="makepdf(<?php echo $article['facture_id']; ?>)">
