...
<aside fragment="navbar" class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link dropdown-toggle " href="scanner_produit.php">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fa-solid fa-house" style="font-size: 16px; color: #4f4f4f;"></i>
                    </div>
                            ...
                            <div id="produitsContainer">
                                <div class="produit mb-3 d-flex align-items-end produit-ligne">
                                    <div class="form-group me-2">
                                        ...
                                        <input type="number" class="form-control fixed-end" name="ticket_id"  required>
                                    </div>

                                </div>
                            </div>

                            <button type="submit" class="btn btn-primary px-5 py-2">Valider le retour</button>
                        </form>
                    </div>
                </div>
