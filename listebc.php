...
?>
<?php
include 'db.php'; // Include your Dbf class

$db = new Dbt(); // Instantiate the class
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="submenuFacture">
                    <ul class="nav flex-column ms-4">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="listebc.php">
                                <i class="bi bi-list-ul text-dark text-sm opacity-10 me-2"></i>
                                Liste des commande
                            </a>
                        </li>
...
<main class="main-content position-relative border-radius-lg ">
    ...
    $stmt_articles = $db->prepare("SELECT bl.*, p.*,c.*,bld.* FROM produits p , bons_commande bl,clients c,bons_commande_details bld  where c.id=bl.fournisseur_id and bld.bon_commande_id =bl.id and bld.produit_id=p.code_barre");
                ...
                <div class="card shadow-lg rounded-lg">
                    ...
                    <div class="card-body p-4">    <table id="clientTable" class="table align-items-center mb-0">
                            ...
                            <tr>
                                ...
                                <th class="text-uppercase text-xs font-weight-bold ps-2">prix TVA</th>
                            ...
                            <?php foreach ($articles as $article): ?>
                                <tr>
                                    ...
                                    <td><?php echo htmlspecialchars($article['adresse']); ?></td>
                                    <td><?php echo htmlspecialchars($article['created_at']); ?></td>
                                    <td><?php echo htmlspecialchars($article['title']); ?></td>
                                    <td><?php echo htmlspecialchars($article['quantite']); ?></td>
                                    <td><?php echo htmlspecialchars($article['total_ht']); ?></td>
                                    <td><?php echo htmlspecialchars($article['total_tva']); ?></td>
                                    <td><?php echo htmlspecialchars($article['total_ttc']); ?></td>



                                    <td>
                                        <a href="javascript:void(0);" class="btn btn-danger btn-sm"
                                           onclick="confirmDeleteFacture(<?php echo $article['bon_commande_id']; ?>)">
                                            <i class="bi bi-trash-fill"></i> Supprimer
                                        </a>
                                        <a href="javascript:void(0);" class="btn btn-warning btn-sm"
                                           onclick="makeFacture(<?php echo $article['bon_commande_id']; ?>)">
                                            <i class="bi bi-palette"></i> fact
                                        </a>

                                        <a href="javascript:void(0);" class="btn btn-print btn-sm"
                                           onclick="makepdf(<?php echo $article['bon_commande_id']; ?>)">
                                            <i class="bi bi-filetype-pdf"></i> imp
                                        </a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
