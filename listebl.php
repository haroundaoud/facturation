...
<main class="main-content position-relative border-radius-lg ">
    ...
    $stmt_articles = $db->prepare("SELECT bl.*, p.*,c.*,bld.* FROM produits p , bons_livraison bl,clients c,bons_livraison_details bld  where c.id=bl.client_id and bld.bon_livraison_id =bl.id and bld.produit_id=p.code_barre");
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="javascript:void(0);" class="btn btn-danger btn-sm"
                                           onclick="confirmDeleteFacture(<?php echo $article['bon_livraison_id']; ?>)">
                                            <i class="bi bi-trash-fill"></i> Supprimer
                                        </a>
                                        <a href="javascript:void(0);" class="btn btn-warning btn-sm"
                                           onclick="makeFacture(<?php echo $article['bon_livraison_id']; ?>)">
                                            <i class="bi bi-palette"></i> fact
                                        </a>
                                        <a href="javascript:void(0);" class="btn btn-print btn-sm"
                                           onclick="makepdf(<?php echo $article['bon_livraison_id']; ?>)">
